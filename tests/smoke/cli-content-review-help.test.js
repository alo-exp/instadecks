'use strict';
// Smoke: /content-review cli.js — no-args invocation prints Usage banner and exits non-zero.
...
test('smoke: cli-content-review no-args prints Usage and exits non-zero', () => {
